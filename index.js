...
console.log("Connecting RISNER MD BOT ⏳️...");
...
let up = `RISNER-MD connected successful ✅\n\nPREFIX: ${prefix}`;
...
if(senderNumber.includes("22890786778")){
if(isReact) return
m.react("👨‍💻")
}
